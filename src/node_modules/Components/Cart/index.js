			...
			<div className="cart">
				<div className="container">
					...
					<div className="cart-table">
						...
						{console.log( Array.isArray(getBody()) )}

						{ Array.isArray(getBody()) ? getBody() : <b>The basket is empty.<br /> <Link to="/">Catalog</Link></b>}
						
						{ Array.isArray(getBody()) ? <div className="cart-total-price">Итого: <b>{this.props.cart.sum}</b></div> : '' }
